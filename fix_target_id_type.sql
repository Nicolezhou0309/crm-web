...
-- 1. 检查points_exchange_records表的实际结构
SELECT 
    column_name, 
    data_type, 
    is_nullable,
...
-- 2. 如果target_id是bigint类型，我们需要修改exchange_goods_item函数
-- 将p_goods_id转换为bigint或者使用其他方式存储

-- 3. 修改exchange_goods_item函数，使用goods_id的hash值作为target_id
