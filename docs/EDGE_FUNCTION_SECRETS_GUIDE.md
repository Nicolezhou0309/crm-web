...
```bash
# 设置Supabase配置
supabase secrets set SUPABASE_URL=172.29.115.115:8000 --project-ref aliyun-supabase
...
# Supabase配置
supabase secrets set SUPABASE_URL="172.29.115.115:8000" --project-ref $PROJECT_REF
