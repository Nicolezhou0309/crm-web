...
```bash
# 设置Supabase配置
supabase secrets set SUPABASE_URL=47.123.26.25:8000 --project-ref aliyun-supabase
...
# Supabase配置
supabase secrets set SUPABASE_URL="47.123.26.25:8000" --project-ref $PROJECT_REF
