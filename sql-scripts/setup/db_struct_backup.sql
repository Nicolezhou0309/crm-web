...
-- 跟进记录多条件过滤查询函数备份
CREATE OR REPLACE FUNCTION public.filter_followups(p_created_at_end timestamp with time zone DEFAULT NULL::timestamp with time zone, p_created_at_start timestamp with time zone DEFAULT NULL::timestamp with time zone, p_customerprofile customerprofile[] DEFAULT NULL::customerprofile[], p_followupresult text[] DEFAULT NULL::text[], p_followupstage followupstage[] DEFAULT NULL::followupstage[], p_interviewsales_user_id bigint[] DEFAULT NULL::bigint[], p_leadid text[] DEFAULT NULL::text[], p_leadtype text[] DEFAULT NULL::text[], p_limit integer DEFAULT NULL::integer, p_majorcategory text[] DEFAULT NULL::text[], p_moveintime_end timestamp with time zone DEFAULT NULL::timestamp with time zone, p_moveintime_start timestamp with time zone DEFAULT NULL::timestamp with time zone, p_offset integer DEFAULT 0, p_remark text DEFAULT NULL::text, p_scheduledcommunity community[] DEFAULT NULL::community[], p_showingsales_user bigint[] DEFAULT NULL::bigint[], p_source source[] DEFAULT NULL::source[], p_userbudget text[] DEFAULT NULL::text[], p_userbudget_min numeric DEFAULT NULL::numeric, p_userbudget_max numeric DEFAULT NULL::numeric, p_userrating userrating[] DEFAULT NULL::userrating[], p_wechat text[] DEFAULT NULL::text[], p_worklocation text[] DEFAULT NULL::text[], p_phone text[] DEFAULT NULL::text[], p_qq text[] DEFAULT NULL::text[], p_location text[] DEFAULT NULL::text[], p_budget text[] DEFAULT NULL::text[], p_douyinid text[] DEFAULT NULL::text[], p_douyin_accountname text[] DEFAULT NULL::text[], p_staffname text[] DEFAULT NULL::text[], p_redbookid text[] DEFAULT NULL::text[], p_area text[] DEFAULT NULL::text[], p_notelink text[] DEFAULT NULL::text[], p_campaignid text[] DEFAULT NULL::text[], p_campaignname text[] DEFAULT NULL::text[], p_unitid text[] DEFAULT NULL::text[], p_unitname text[] DEFAULT NULL::text[], p_creativedid text[] DEFAULT NULL::text[], p_creativename text[] DEFAULT NULL::text[], p_traffictype text[] DEFAULT NULL::text[], p_interactiontype text[] DEFAULT NULL::text[], p_douyinleadid text[] DEFAULT NULL::text[], p_leadstatus text[] DEFAULT NULL::text[], p_keyword text DEFAULT NULL::text)
 RETURNS TABLE(id uuid, leadid text, lead_uuid uuid, leadtype text, followupstage followupstage, followupstage_name text, customerprofile customerprofile, customerprofile_name text, worklocation text, worklocation_id text, userbudget text, userbudget_id text, moveintime timestamp with time zone, scheduletime timestamp with time zone, created_at timestamp with time zone, updated_at timestamp with time zone, userrating userrating, userrating_name text, majorcategory text, majorcategory_id text, followupresult text, followupresult_id text, scheduledcommunity community, scheduledcommunity_name text, phone text, wechat text, source source, source_name text, remark text, interviewsales_user_id bigint, interviewsales_user_name text, showingsales_user_id bigint, showingsales_user_name text, qq text, location text, budget text, douyinid text, douyin_accountname text, staffname text, redbookid text, area text, notelink text, campaignid text, campaignname text, unitid text, unitname text, creativedid text, creativename text, traffictype text, interactiontype text, douyinleadid text, leadstatus text, invalid boolean, total_count bigint)
 LANGUAGE plpgsql
AS $function$DECLARE
