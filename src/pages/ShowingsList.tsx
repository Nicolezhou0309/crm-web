    ...
    >
      {showFilters && (
        <Form layout="vertical" onFinish={handleFilter}>
          <Row gutter={16}>
            <Col span={6}>
              <Form.Item label="线索ID" name="leadid">
            ...
            <Col span={6}>
              <Form.Item label="带看销售" name="showingsales">
                <Select placeholder="请选择带看销售" allowClear mode="multiple">
            ...
            <Col span={6}>
              <Form.Item label="实际销售" name="trueshowingsales">
                <Select placeholder="请选择实际销售" allowClear mode="multiple">
                  {salesOptions.map(option => (
                    <Select.Option key={option.value} value={option.value}>
                      {option.label}
                    </Select.Option>
          ...
          <Row gutter={16}>
            <Col span={6}>
              <Form.Item label="约访销售" name="interviewsales">
                <Select placeholder="请选择约访销售" allowClear mode="multiple">
                  {salesOptions.map(option => (
                    <Select.Option key={option.value} value={option.value}>
                      {option.label}
                    </Select.Option>
            ...
            <Col span={6}>
              <Form.Item label="看房结果" name="viewresult">
                <Select placeholder="请选择看房结果" allowClear mode="multiple">
            ...
            <Col span={6}>
              <Form.Item label="租期范围">
                <Input.Group compact>
                  <Form.Item name="renttime_min" noStyle>
                    <InputNumber placeholder="最小值" style={{ width: '50%' }} />
                  </Form.Item>
                  <Form.Item name="renttime_max" noStyle>
                    <InputNumber placeholder="最大值" style={{ width: '50%' }} />
                  </Form.Item>
                </Input.Group>
              </Form.Item>
          ...
          <Row gutter={16}>
            <Col span={8}>
              <Form.Item label="预约时间范围" name="scheduletime_range">
                <RangePicker 
                  showTime 
            ...
            <Col span={8}>
              <Form.Item label="到达时间范围" name="arrivaltime_range">
                <RangePicker 
                  showTime 
                  placeholder={['开始时间', '结束时间']}
                  style={{ width: '100%' }}
            ...
            <Col span={8}>
              <Form.Item label="入住时间范围" name="moveintime_range">
                <RangePicker 
                  placeholder={['开始时间', '结束时间']}
                  style={{ width: '100%' }}
                />
